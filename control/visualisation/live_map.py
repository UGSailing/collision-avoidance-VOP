"""
    AI generated visualisation tool to inspect the data generated by a run.
    Can be run live with auto update from main.py or manually by giving it a folder with points.csv and path.csv.
"""
